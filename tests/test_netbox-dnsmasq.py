...
from netbox_dnsmasq import (restart_service,
                            get_ip_data,
                            format_dhcp,
                            format_dns,
                            write_config,
...
def test_write_config(caplog, example_netbox_data, tmp_path):
    ...
    write_config(dhcplist=example_netbox_data['formatted_dhcp'],
...
@pytest.mark.vcr
def test_get_ip_data(caplog, example_netbox_data, example_config_data, set_test_environment):
    """
...
def test_check_duplicates(caplog, example_netbox_data):
    ...
    for correct output based on input described in the example_netbox_data fixture.
    Args:
        caplog: Pytest fixture for capturing log output
        example_netbox_data: Pytest fixture for example Netbox data
    """
